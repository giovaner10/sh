...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Não ja resgistros na tabela"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
oPaginate:{sFirst:"Primeira",sLast:"Ultima",sNext:"Proximo",sPrevious:"Anterior"},sEmptyTable:"Não ha registros na tabela",sInfo:"Exibindo _START_ para _END_ de _TOTAL_ entradas",sInfoEmpty:"Exibindo 0 para 0 de 0 entradas",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Exiba _MENU_ entradas",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Pesquisar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Não ha registros para serem exibidos para sua pesquisa"},oSearch:h.extend({},
