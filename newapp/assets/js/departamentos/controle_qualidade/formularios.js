...
function atualizarAgGrid(dados) {
    ...
    const gridOptions = {
                    ...
                    let buttons = [
                        {
                            ...
                            html: `
                                <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                    <a href="${uploadUrl}/${data[2].arquivo}" download data-toggle="tooltip">Baixar</a>
                                </div>
                            `
                        },
                        {
                            ...
                            html: `
                                <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                    <a href="${uploadUrl}/${data[2].arquivo}" target="_blank" data-toggle="tooltip">Visualizar</a>
                                </div>
                            `
                        }
                    ];
                        ...
                        buttons.push(
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="formularioEditarFormulario(${data[0]})" data-toggle="tooltip" id="buttonEditarFormulario_${data[0]}">Editar</a>
                                    </div>
                                `
                            },
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="modalExcluirFormulario(${data[0]})" data-toggle="tooltip">Remover</a>
                                    </div>
                                `
                            }
                        );
        ...
        pagination: true,
        domLayout: 'normal',
        paginationPageSize: parseInt($('#select-quantidade-por-pagina-formularios').val()),
        localeText: localeText
    };


    var gridDiv = document.querySelector('#tableFormularios');
    ...
    $('#select-quantidade-por-pagina-formularios').change(function () {
...
function stopAgGRID() {
    ...
    var wrapper = document.querySelector('.wrapperFormularios');
    if (wrapper) {
        wrapper.innerHTML = '<div id="tableFormularios" class="ag-theme-alpine my-grid-formularios"></div>';
    }
}
...
function preencherExportacoes(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function (event) {
            ...
            exportarArquivo(opcao, gridOptions, 'RelatorioFormularios', 'Relatório de Formulários');
        });
