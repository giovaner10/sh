function exportarArquivo(tipo, gridOptions, menu, titulo) {
    let colunas = ['nome', 'ip', 'porta', 'ativa', 'cnpj', 'id_central_mhs'];
...
$(document).ready(function() {
    var dropdown = $('#opcoes_exportacao_central');
...
function preencherExportacoes(gridOptions) {
    const formularioExportacoes = document.getElementById('opcoes_exportacao_central');
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions, 'RelatorioCentraisMhs', 'Relatório de Centrais MHS');
        });
