...
function exportarArquivo(tipo, gridOptions,menu, titulo) {
    ...
    let colunas = [];
    if (menu === "iscasClientes") {
        colunas = ['serial', 'mensagens', 'nomeCliente', 'documento', 'endereco', 'latitude', 'longitude'];
    }else if(menu === "isca"){
        colunas = ['serial', 'mensagens', 'endereco', 'latitude', 'longitude'];
    }else if (menu === "relatorioLora"){
        colunas = ['serial', 'motivo', 'nomeCliente', 'documento', 'tipoComunicacaoLora', 'endereco', 'latitude', 'longitude', 'ignicao', 'modoEmergencia'];
    }else if (menu === "historicoComandos"){
        colunas = ['cmdId', 'cmdEqp', 'cmdComando', 'cmdCadastro', 'cmdEnvio', 'descricaoStatus'];
    } else if (menu === "associacaoLora"){
        colunas = ['id', 'nomeCliente', 'serial', 'idLora', 'dataCadastro', 'status'];
    }
...
function preencherExportacoesIsca(gridOptions, titulo) {
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions,'isca', titulo);
        });
...
function preencherExportacoesIscaCliente(gridOptions, titulo) {
    const formularioExportacoes = document.getElementById('opcoes_exportacao');
    const opcoes = ['csv', 'excel', 'pdf'];
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            event.preventDefault();
            exportarArquivo(opcao, gridOptions,'iscasClientes', titulo);
        });
...
function preencherExportacoesLora(gridOptions, titulo) {
    const formularioExportacoes = document.getElementById('opcoes_exportacao');
    const opcoes = ['csv', 'excel', 'pdf'];
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            event.preventDefault();
            exportarArquivo(opcao, gridOptions, "relatorioLora", titulo);
        });
...
function preencherExportacoesHistoricoComandos (gridOptions, titulo) {
    const formularioExportacoes = document.getElementById('opcoes_exportacao');
    const opcoes = ['csv', 'excel', 'pdf'];
    ...
    opcoes.forEach(opcao => {
        ...
        let div = document.createElement('div');
        div.classList.add('dropdown-item');
        div.classList.add('opcoes_exportacao_historico');
        div.setAttribute('data-tipo', opcao);
        div.innerHTML = `
        <img src="${button}" alt="Ícone" style="width: 15px; margin-left: 10px; cursor: pointer;" title="Exportar no formato ${texto}">
        <label style="cursor: pointer; margin-top: 7px;" title="Exportar no formato ${texto}">${texto}</label>
    `;
        ...
        div.addEventListener('click', function(event) {
            event.preventDefault();
            exportarArquivo(opcao, gridOptions, "historicoComandos", titulo);
        });
...
function preencherExportacoesAssociacaoLoRa (gridOptions, titulo) {
    const formularioExportacoes = document.getElementById('opcoes_exportacao');
    const opcoes = ['csv', 'excel', 'pdf'];
    ...
    opcoes.forEach(opcao => {
        ...
        let div = document.createElement('div');
        div.classList.add('dropdown-item');
        div.classList.add('opcoes_exportacao_associacao');
        div.setAttribute('data-tipo', opcao);
        div.innerHTML = `
        <img src="${button}" alt="Ícone" style="width: 15px; margin-left: 10px; cursor: pointer;" title="Exportar no formato ${texto}">
        <label style="cursor: pointer; margin-top: 7px;" title="Exportar no formato ${texto}">${texto}</label>
    `;
        ...
        div.addEventListener('click', function(event) {
            event.preventDefault();
            exportarArquivo(opcao, gridOptions, "associacaoLora", titulo);
        });
