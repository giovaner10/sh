...
function atualizarAgGrid(dados) {
    ...
    const gridOptions = {
                        ...
                        buttons.push(
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="formularioEditarSuporte(${data[0]})" data-toggle="tooltip" id="buttonEditarRetencao_${data[0]}">Editar</a>
                                    </div>
                                `
                            }
                        );
                        ...
                        buttons.push(
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="excluirSuporte(${data[0]})" data-toggle="tooltip">Remover</a>
                                    </div>
                                `
                            }
                        );
        ...
        pagination: true,
        domLayout: 'normal',
        paginationPageSize: parseInt($('#select-quantidade-por-pagina-suporte').val()),
        localeText: localeText
    };
    var gridDiv = document.querySelector('#tableSuporte');
    ...
    $('#select-quantidade-por-pagina-suporte').change(function () {
...
function stopAgGRID() {
    ...
    var wrapper = document.querySelector('.wrapperSuporte');
    if (wrapper) {
        wrapper.innerHTML = '<div id="tableSuporte" class="ag-theme-alpine my-grid-suporte"></div>';
    }
}
...
function preencherExportacoes(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function (event) {
            ...
            exportarArquivo(opcao, gridOptions, 'RelatorioSuporteN2', 'Relatório de Suporte N2');
        });
