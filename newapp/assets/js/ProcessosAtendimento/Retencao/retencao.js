...
function atualizarAgGrid(dados) {
    ...
    const gridOptions = {
                        ...
                        buttons.push(
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="formularioEditarRetencao(${data[0]})" data-toggle="tooltip" id="buttonEditarRetencao_${data[0]}">Editar</a>
                                    </div>
                                `
                            }
                        );
                        ...
                        buttons.push(
                            {
                                ...
                                html: `
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a onclick="excluirRetencao(${data[0]})" data-toggle="tooltip">Remover</a>
                                    </div>
                                `
                            }
                        );
        ...
        pagination: true,
        domLayout: 'normal',
        paginationPageSize: parseInt($('#select-quantidade-por-pagina-retencao').val()),
        localeText: localeText
    };


    var gridDiv = document.querySelector('#tableRetencao');
    ...
    $('#select-quantidade-por-pagina-retencao').change(function () {
...
function stopAgGRID() {
    ...
    var wrapper = document.querySelector('.wrapperRetencao');
    if (wrapper) {
        wrapper.innerHTML = '<div id="tableRetencao" class="ag-theme-alpine my-grid-retencao"></div>';
    }
}
