...
function exportarArquivo(tipo, gridOptions, titulo) {
    let colunas = ['id', 'equipamento', 'comando', 'dataCadastro', 'dataEnvio', 'dataConfirmacao', 'descricaoStatus', 'idUsuario'];

    switch (tipo) {
        case 'csv':
            fileName = "relatorioComandos" + '.csv';
            ...
            break;
        case 'excel':
            fileName = "relatorioComandos" + '.xlsx';
        ...
        case 'pdf':
            ...
            pdfMake.createPdf(definicoesDocumento).download("relatorioComandos" + '.pdf');
            break;
    }
}
...
function preencherExportacoes(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions, 'Relatório de Comandos Enviados');
        });
