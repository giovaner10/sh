function exportarArquivo(tipo, gridOptions, menu = '', titulo) {
    let colunas = [];
    if (menu === 'RelatorioLogNexxera') {
        colunas = ['id', 'tipoDocumentoCopy1', 'bancoIntegrado', 'descricao', 'dataCadastro', 'status'];
    } 
...
function preencherExportacoes(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions, 'RelatorioLogNexxera', 'Relatório Log de Transações');
        });
