...
function exportarArquivo(tipo, gridOptions,menu, titulo) {
    let colunas;
    if (menu === "relatorioEquipamentos") {
        colunas = ["id", "serial", "modelo", "data_cadastro", "linha1", "ccid1", "linha2","ccid2", "info", "status"]
    }
...
function preencherExportacoesEquipamentos(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions,'relatorioEquipamentos', 'Relatório de Equipamentos');
        });
