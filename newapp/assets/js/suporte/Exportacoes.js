function exportarArquivo(tipo, gridOptions, menu, titulo) {
    let colunas = ['conta_id', 'tipo', 'nome_cliente', 'id_contrato', 'placa', 'data_cadastro', 'nome_user', 'status'];
...
function preencherExportacoes(gridOptions) {
    ...
    `;
        ...
        div.addEventListener('click', function(event) {
            ...
            exportarArquivo(opcao, gridOptions, 'RelatorioOS', 'Relatório Ordem de Serviço');
        });
