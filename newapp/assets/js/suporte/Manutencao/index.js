...
function atualizarAgGrid(options) {
    ...
    function getServerSideDados() {
        return {
            getRows: (params) => {
                var route = Router + '/get_contratos_manutencao_troca_retirada';
                            ...
                            <div class="dropdown dropdown-table" data-tableId="${tableId}" style="position: relative;">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow dropdown-menu-acoes" id="${dropdownId}" style="position:absolute;" aria-labelledby="${buttonId}">
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a href="${SiteURL + '/servico/gerar_ordem_servico/4/' + data.id + '/' + data.id_cliente + '/' + data.quantidade_veiculos}" target="_blank" style="cursor: pointer; color: black;">Gerar OS - Manutenção</a>
                                    </div>
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a href="${SiteURL + '/servico/gerar_ordem_servico/2/' + data.id + '/' + data.id_cliente + '/' + data.quantidade_veiculos}" target="_blank" style="cursor: pointer; color: black;">Gerar OS - Troca</a>
                                    </div>
                                    <div class="dropdown-item dropdown-item-acoes" style="cursor: pointer;">
                                        <a href="${SiteURL + '/servico/gerar_ordem_servico/3/' + data.id + '/' + data.id_cliente + '/' + data.quantidade_veiculos}" target="_blank" style="cursor: pointer; color: black;">Gerar OS - Retirada</a>
                                    </div>
                                </div>
                            </div>`;
                    } else {
