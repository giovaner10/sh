    ...
    <STYLE>
        ...
        @media screen,print {
            ...
            * {
            ...
            #instr_header {
                background: url('<?php echo base_url('asset/media/boleto') ?>/logo_empresa.png') no-repeat top left;
                padding-left: 160px;
                height: 65px;
            }
    ...
    <div id="container">
        ...
        <div id="boleto">
            ...
            do Sacado</b></div></TD></tr></tbody></table>
                            ...
                            <tbody>
                            <tr>
                                    <td width=150><IMG SRC="<?php echo base_url('asset/media/boleto') ?>/logobb.jpg"></td>
                                    <td width=50>
            ...
            <table class="header" border=0 cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td width=150><IMG SRC="<?php echo base_url('assets/media/') ?>/logobb.jpg"></td>
                        <td width=50>
                            <div class="field_cod_banco"><?php echo $dadosboleto["codigo_banco_com_dv"] ?></div>
                        </td>
                        <td class="linha_digitavel"><?php echo $dadosboleto["linha_digitavel"] ?></td>
