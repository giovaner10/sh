...
$lang['db_invalid_connection_str'] = 'Não foi possível determinar as configurações do banco de dados com base na string de conexão que você enviou.';
...
$lang['db_unsuported_feature'] = 'Recurso não suportado da plataforma de banco de dados que você está usando.';
...
$lang['db_column_definition_required'] = 'Uma definição de coluna é necessária para esta operação.';
