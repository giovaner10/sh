...
<!-- <?php echo form_open('', array('class' => 'form-horizontal'))?> -->
	...
	<div class="modal-content" style="box-shadow: none;">
		<div class="modal-header header-layout" style="text-align: center;">
			...
			<h3 class="modal-title" id="titleWhitelist">Administrar Veículo</h3>
		</div>
			...
			<form id=form-cad-veiculo>
				...
				<div class="row veic-form-group">
					...
					<div class="form-group col-sm-4">
						...
						<input type="number" min="0" name="hodometro" class="form-control" value="<?php echo $this->input->post('hodometro') ? $this->input->post('hodometro') : round($veiculo->hodometro) ?>" disabled/> 
					</div>
				</div>
				<div class="row veic-form-group">
					<span class="help help-block"></span>
					<div class="form-group col-sm-4">
						...
						<input type="number" min="0" name="horimetro" class="form-control" value="<?= $this->input->post('horimetro') ? $this->input->post('horimetro') : round($veiculo->horimetro) ?>" disabled>
					</div>
					<span class="help help-block"></span>
					<div class="form-group col-sm-4">
				...
				<div class="row veic-form-group">
					...
					<div class="form-group col-sm-12">
						...
						<textarea name="observacao" maxlength="500" rows="5" style="resize: vertical;" class="form-control"></textarea>
					</div>
				</div>
...
<script>
	$('#modalVeiculoCadastro').on('shown.bs.modal', function () {
		...
		$('#form-cad-veiculo').submit(function (e) {
			...
			$.ajax({
				url: BASE_URL + 'cadastros/atualizar_veiculo_ns/' + code,
				type: 'POST',
				data: formDataObject,
				dataType: 'json',
