					...
					<div class="card">
						<div class="card-body">
							...
							<div>
								...
								<div class="form-group">
									<label for="exampleInputPassword1"><?php echo lang('senha');?></label>
									<input type="password" name="senha" class="form-control" placeholder="<?php echo lang('digsenha')?>" required>
								</div>
								<div align="center">
									<button type="submit" class="btn btn-large btn-primary" style="width: 100%" type="button" id="entrar"><?php echo lang('entrar')?></button>
								</div>
								<br>
							</form>
