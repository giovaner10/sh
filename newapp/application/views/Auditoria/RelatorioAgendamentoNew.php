<div class="text-title">
    <h3 style="padding: 0 20px; margin-left: 15px;"><?= lang("relatorio_instalacao") ?></h3>
...
<div class="row" style="margin: 15px 0 0 15px;">
    <div class="col-md-3">
        <div class="card menu-interno">
            ...
            <ul>
                <li>
                    <a class='menu-interno-link selected' id="menu-relatorio-instalacao"><?= lang("relatorio_instalacao") ?></a>
                </li>
                <li>
                    <a class='menu-interno-link' id="menu-dashboard-instalacao">Dashboard de Instalação</a>
                </li>
            </ul>
        </div>
            ...
            <div class="chartPlotContainer" id="chartContainer" style="flex-wrap: wrap;">
                ...
                <div class="chartContainer container" style="position: relative;" id="chartBarButton">
                    ...
                    <div class="container chartHeader">
                        <charttitle>Relatório de Instalação - Gráfico Barra</charttitle>
                    </div>
                ...
                <div class="chartContainer container" style="position: relative;" id="chartLineButton">
                    ...
                    <div class="container chartHeader">
                        <charttitle>Relatório de Instalação - Gráfico Linha</charttitle>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Relatório de Instalação - Gráfico Barra</h3>
            </div>
...
<div class="modal fade" id="chartLineModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title">Relatório de Instalação - Gráfico Linha</h3>
            </div>
            <div class="modal-body" style="height: 500px;">
                <div class="col-md-12" style="height: 500px;">
...
<!-- Page Related -->
<script type="text/javascript" src="<?= versionFile('assets/js/agendamento/RelatorioInstalacao', 'index.js') ?>"></script>