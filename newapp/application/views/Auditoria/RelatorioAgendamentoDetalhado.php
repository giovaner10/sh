<div class="text-title">
    <h3 style="padding: 0 20px; margin-left: 15px;"><?= lang("relatorio_instalacao_detalhado") ?></h3>
    <h4 style="padding: 0 20px; margin-left: 15px;">
        <a style="text-decoration: none" href="<?= site_url('Homes') ?>">Home</a> >
        <?= lang('auditoria') ?> >
        <?= lang('auditoria_agendamento') ?> >
        <?= lang('relatorio_instalacao_detalhado') ?>
    </h4>
</div>
...
<div class="row" style="margin: 15px 0 0 15px;">
    <div class="col-md-3">
        <div class="card menu-interno">
            ...
            <ul>
                <li>
                    <a class='menu-interno-link selected' id="menu-relatorio-instalacao"><?= lang('relatorio_instalacao_detalhado') ?></a>
                </li>
            </ul>
        </div>
...
<!-- Page Related -->
<script type="text/javascript" src="<?= versionFile('assets/js/agendamento/RelatorioInstalacaoDetalhado', 'index.js') ?>"></script>