...
<h3>Alterar Tabela de Preços e Acessórios</h3>
<hr>
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url("cadastros/edit_precos_acessorios/$dado_espaco_ti->id")?>">
    	<div class="box-body">
    		...
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="<?php echo site_url('cadastros/listar_precos_acessorios');?>" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
