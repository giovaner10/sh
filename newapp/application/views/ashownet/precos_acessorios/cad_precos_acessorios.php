...
<h3>Cadastro Tabela de Preços e Acessórios</h3>
<hr>
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url('cadastros/cad_precos_acessorios')?>">
    	<div class="box-body">
