...
<h3>Televendas Comunicados</h3>
<hr>
<div>
    <div class="row-fluid">
        <div class="span9">
            <div class="btn-group">
                <a href="<?php echo site_url('cadastros/televendas_comunicados')?>" class="btn btn-success"><i class="icon-plus icon-white"></i> Novo arquivo</a>
            </div>
        </div>
    </div>
	...
	<?php foreach ($lista_arquivos as $lista_arquivo){?>
		<tr>
			...
			<td style="text-align: center; vertical-align: middle;">
    			<a href="<?php echo site_url("cadastros/editar_televendas_comunicados/$lista_arquivo->id")?>" class="btn btn-mini btn-primary" title="Editar informação">
...
function excluir(id) {
	...
	if (r == true) { 
        var url = "<?= site_url('cadastros/excluir_televendas_comunicados').'/' ?>"+id;
