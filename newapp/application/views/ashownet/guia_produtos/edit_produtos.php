...
<h3>Alterar Guia de Produtos</h3>
<hr>
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url("cadastros/edit_guia_produtos/$dado_espaco_ti->id")?>">
    	<div class="box-body">
    		...
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="<?php echo site_url('cadastros/listar_guia_produtos');?>" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
