...
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" action="<?php echo site_url("cadastros/edit_comite_guerra/$apresentacao->id")?>">
    	<div class="box-body">
    		...
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="<?php echo site_url("cadastros/listar_comite_guerra")?>" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
        ...
        <table id="table" class="table table-bordered table-hover">
        	...
        	<?php foreach ($apresentacoes as $apresentacao){
        		...
        		<tr>
        			...
        			<?php }else{ ?>
        			<td style="text-align: center; vertical-align: middle;"><img src="<?php echo base_url("uploads/comite_guerra/$apresentacao->file");?>" width="200px"></td>
        			<?php } ?>
...
function excluir(id) {
	...
	if (r == true) { 
        var url = "<?= site_url('cadastros/excluir_comite_guerra_imagens').'/' ?>"+id;
