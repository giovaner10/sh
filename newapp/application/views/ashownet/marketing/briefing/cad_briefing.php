...
<h3>Cadastro Marketing Briefing</h3>
<hr>
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url('cadastros/cad_marketing_briefing')?>">
    	<div class="box-body">
