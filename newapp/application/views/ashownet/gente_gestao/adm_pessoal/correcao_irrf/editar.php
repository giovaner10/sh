...
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url("cadastros/edit_correcao_irrf/$dados->id")?>">
    	<div class="box-body">
    		<div class="form-group">
    			<label for="descricao" class="col-sm-2 control-label">Título</label>
    			<div class="col-sm-6">
    				<input type="text" class="form-control" name="titulo" id="titulo" value="<?=$dados->titulo?>">
    			</div>
    		</div>
    		<div class="form-group">
    			<label for="descricao" class="col-sm-2 control-label">Descrição</label>
    			<div class="col-sm-6">
    				<textarea class="editor" name="sobre"><?=$dados->descricao?></textarea>
    			</div>
    		</div>
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="<?php echo site_url("cadastros/listar_correcao_irrf")?>" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
