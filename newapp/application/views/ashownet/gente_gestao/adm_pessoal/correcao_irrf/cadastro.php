...
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url("cadastros/cad_coreccao_irrf")?>">
    	<div class="box-body">
    		...
    		<div class="form-group">
    			...
    			<div class="col-sm-6">
    				<textarea class="editor" name="sobre"></textarea>
    			</div>
    		</div>
