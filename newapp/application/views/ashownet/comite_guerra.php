...
<div class="containner">
	...
	<div class="btn-group pull-right">
		<a class="btn btn-success btn-xs" href="<?php echo site_url('cadastros/listar_comite_guerra');?>">INCLUIR</a>
	</div>
	<?php } ?>
	<h5><?php echo $titulo;?></h5>
	<h2 class="TitPage">Comitê de Guerra</h2>
	<div class="row">
				...
				<div class="col-sm-4">
					<div class="panel panel-default">
						<div class="panel-body text-center">
							...
							<?php 
							$query = $this->db->query("SELECT id_apresentacao, file FROM cad_comite_guerra_arquivos WHERE id_apresentacao ='$apresentacao->id'");
							...
							<div class="col-sm-12" <?php echo $visualizarImagem;?> >
								<img  src="<?php echo base_url("uploads/comite_guerra/$arquivoImage");?>" width="100%"><br>
								<br>
							</div> 					
							<div class="col-sm-6 text-center " <?php echo $visualizarImagem;?>>
								<a  href="<?php echo base_url("uploads/comite_guerra/$arquivoImage");?>"class="btn btn-primary vapresentacao<?=$row['id_apresentacao']?>">Reproduzir</a>
							</div>
							<?php } ?>
							<?php $i++;} ?>
							<div class="col-sm-6 text-center">
								<a href="<?php echo base_url("uploads/comite_guerra/$arquivoDownload");?>" class="btn btn-primary">Download</a>
							</div>
						</div>
					</div>
				</div>
