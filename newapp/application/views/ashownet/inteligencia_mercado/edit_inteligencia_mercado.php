...
<h3>Alterar Inteligência de Mercado</h3>
<hr>
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url("cadastros/edit_inteligencia_mercado/$dado_espaco_ti->id")?>">
    	<div class="box-body">
    		...
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="<?php echo site_url('cadastros/listar_inteligencia_mercado');?>" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
