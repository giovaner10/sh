...
tituloPaginaComponente('Gerenciador de Tickets', site_url('Homes'), "Pós-vendas", 'Gerenciador de Tickets');
?>
...
<div class="row" style="margin: 15px 0 0 15px;">
    <div class="col-md-3">
        ...
        <div class="card menu-interno">
            ...
            <ul>
                <li>
                    <a style="background: #1C69AD !important; color: #fff !important; font-family: 'Mont SemiBold';" class='menu-interno-link <?= $menu_omnicom == 'CadastroDeClientes' ? 'selected' : '' ?>' id="menu-cadastro-clientes">Gerenciador de Tickets</a>
                </li>
            </ul>
        </div>
    ...
    <div class="col-md-9" id="conteudo">
        ...
        <div class="card-conteudo card-cadastro-clientes" style='margin-bottom: 20px; <?= $menu_omnicom == 'CadastroDeClientes' ? '' : 'display: none;' ?>'>
            <h3>
                <b id="titulo-card">Gerenciador de Tickets: </b>
...
<script>
    ...
    $(document).ready(async function() {
        ...
        async function buscarDadosAgGrid() {
            ...
            await $.ajax({
                url: '<?php echo base_url("PosVenda/Gestao/listar_tickets"); ?>' + '/?usuarioLogado=' + usuarioLogado,
                type: 'GET',
                success: function(response) {
                    result = JSON.parse(response).resultado.tickets;
                    updateData(result)
                    showAlert("success", "Dados carregados!")
                },
        ...
        const gridOptions = {
            columnDefs: [{
                ...
                },
                {
                    ...
                    field: "cliente",
                    valueGetter: function(params) {
                        return params.data.cliente !== null ? params.data.cliente : "";
                    }
                },
                {
                    ...
                    cellRenderer: function(params) {
                        const prioridade = params.data.prioridade;
                        ...
                        return `<p style="color: ${color}; background-color: ${backgroundColor}; margin: 0; padding: 5px; border-radius: 3px;">${tipo}</p>`;
                    }
                },
                {
                    headerName: "Status",
                    ...
                    cellRenderer: function(params) {
                        ...
                        return `<p style="color: ${color}; background-color: ${backgroundColor}; margin: 0; padding: 5px; border-radius: 3px;">${displayText}</p>`;
                    }
                },
                {
                    headerName: "Assunto",
                    field: "assunto",
                    valueGetter: function(params) {
                        return params.data.assunto !== null ? params.data.assunto : "";
                    }
                },
                {
                    ...
                    field: "dataAbertura",
                    valueGetter: function(params) {
                        return params.data.dataAbertura !== null ? params.data.dataAbertura : "";
                    }
                },
                {
                    headerName: "Placa",
                    field: "placa",
                    valueGetter: function(params) {
                        return params.data.placa !== null ? params.data.placa : "";
                    }
                },
                {
                    headerName: "Mensagem",
                    ...
                    width: 380,
                    valueGetter: function(params) {
                        return params.data.mensagem !== null ? params.data.mensagem : "";
                    }
                },
                {
                    headerName: 'Ações',
        ...
        $(".ag-overlay-no-rows-center").html('<div class="spinner"></div>');
        preencherExportacoes(gridOptions, "RelatorioAnalistasDeSuporte");
