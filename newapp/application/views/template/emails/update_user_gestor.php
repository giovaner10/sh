...
<p style="margin: 0; padding-bottom: 0">Os dados de sua conta foram atualizados. Segue abaixo os novos dados:</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
<p style="margin: 0; padding-bottom: 1em"><strong>Usuário:</strong> {email_usuario}<br /><strong>Senha:</strong> {senha_usuario}<br /><strong>Tipo:</strong> {status_usuario}</p>
