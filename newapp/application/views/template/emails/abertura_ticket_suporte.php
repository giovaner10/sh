																				...
																				<tbody>
																					<tr>
																						<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
																							<h3 style="margin: 0; padding-bottom: 1em">Prezado <strong>{{cliente}}</strong></h3>
																							<h5 style="margin: 0; padding-bottom: 1em">Usuário: {{usuario}}</h5>
																							<p style="margin: 0; padding-bottom: 0">Foi constatado que os veículos abaixo estão com os dados desatualizados a mais de 48hs em nosso sistema.</p>
																						</td>
																					</tr>
																					<tr>
																						<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
																							<table border="1" cellpadding="0" cellspacing="0" class="kmTextBlock" width="100%" style="border: 1px solid #ccc;background: #fff;border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0">
																								<thead>
																									<tr>
																										<th style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; padding: 5px; border-color: #cccccc;">Placa</th>
																										<th style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; padding: 5px; border-color: #cccccc;">Serial</th>
																										<th style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; padding: 5px; border-color: #cccccc;">Última atualização</th>
																									</tr>
																								</thead>
																								<tbody class="kmTextBlockOuter">
																									{{lista}}
																					...
																					<tr>
																						<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
																							<p style="margin: 0; padding-bottom: 0">Um ticket foi aberto automaticamente em sua conta. Por favor, responda o mesmo informando os dados necessários para a manutenção, como a data, hora e local da mesma.</p>
																						</td>
																					</tr>
																					<tr>
