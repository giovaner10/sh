...
<style type="text/css">
  @media only screen and (max-width: 480px) {
    ...
    table[id=templateFooter] {
      ...
      td[class=rowContainer] td[class=kmTableBlockInner] [class=kmTextContent],
      td[class=headerContainer] td[class=kmTableBlockInner] [class=kmTextContent],
      td[class=bodyContainer] td[class=kmTableBlockInner] [class=kmTextContent] {
        font-size:18px !important;
        line-height:100% !important;
...
<img align="center" alt="Show Tecnologia" class="kmImage" src="https://d3k81ch9hvuctc.cloudfront.net/company%2F9TqzGS%2Fimages%2Flogo-show.png" width="510" style="border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; padding-bottom: 0; display: inline; vertical-align: bottom; max-width:510px;" />
</td>
</tr>
</tbody>
</table>
...
<p style="margin: 0; padding-bottom: 1em">Prezado {cliente},</p>
<p style="margin: 0; padding-bottom: 0">Informamos que o pagamento da fatura <em><strong>#{id_fatura}</strong></em> com vencimento em <em><strong>{data_vencimento}</strong></em> ainda não foi confirmado. Clique no botão abaixo para imprimir e efetuar o pagamento:</p>
</td>
</tr>
</tbody>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="" class="kmButtonContentContainer" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; background-color: #999; background-color:#0070C9;border-radius:15px;">
<tbody>
<tr>
<td align="center" valign="middle" class="kmButtonContent" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: white; font-family: Helvetica; font-size: 16px; padding: 15px; color:#ffffff;padding:15px;font-size:16px;font-family:Helvetica;">
<a class="kmButton " title="" href="{link_fatura}" target="_self" style="word-wrap: break-word; font-weight: normal; letter-spacing: -0.5px; line-height: 100%; text-align: center; text-decoration: underline; color: #0000cd; font-family: Helvetica; font-size: 16px; text-decoration:initial;color:#ffffff;font-size:16px;font-family:Helvetica;padding-top:0;padding-bottom:0;">Imprimir fatura atualizada</a>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
            Caso já tenha efetuado o pagamento, por favor entre em contato conosco através do email <em>financeiro@showtecnologia.com</em>.
          </td>
</tr>
</tbody>
</table>
...
<p style="margin: 0; padding-bottom: 0"><strong>Financeiro Show Tecnologia</strong></p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
<p style="margin: 0; padding-bottom: 1em; text-align: center;"><span style="font-size: 9px;"><b>Este é um email automático, por favor não responda. Caso tenha alguma dúvida sobre o conteúdo deste email entre em contato através do email financeiro@showtecnologia.com ou pelo telefone 83 3271.4060</b></span></p>
