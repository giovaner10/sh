...
<img align="center" alt="Show Tecnologia" class="kmImage" src="https://d3k81ch9hvuctc.cloudfront.net/company%2F9TqzGS%2Fimages%2Flogo-show.png" width="510" style="border: 0; height: auto; line-height: 100%; outline: none; text-decoration: none; max-width: 100%; padding-bottom: 0; display: inline; vertical-align: bottom; " />
</td>
</tr>
</tbody>
</table>
...
<p style="margin: 0; padding-bottom: 1em">Prezado {nome_usuario},</p>
<p style="margin: 0; padding-bottom: 0">Seu email foi cadastrado como um usuário em nossa ferramenta de monitoramento. Segue abaixo os dados de acesso:</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td class="kmTextContent" valign="top" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; color: #505050; font-family: Helvetica; font-size: 14px; line-height: 150%; text-align: left; padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
<p style="margin: 0; padding-bottom: 1em"><strong>Usuário:</strong> {email_usuario}<br /><strong>Senha:</strong> {senha_usuario}</p>
<p style="margin: 0; padding-bottom: 0">Para ativar sua conta clique no botão abaixo:</p>
</td>
</tr>
</tbody>
</table>
