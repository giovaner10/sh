...
<tbody class="tbodyTopo">
    <tr>
        ...
        <td colspan="1"><?=strtoupper(lang('cnpj'))?>: <b><?=strtoupper('09.338.999/0002-39');?></td>
        <td colspan="2"><?=lang('telefone')?>: <b><?=strtoupper('(83) 3771-3060');?></td>
        <td colspan="2"></td>

    </tr>
    <tr>
        <td colspan="2" ><?=lang('endereco')?>: <b><?=strtoupper(lang('endereco_show_curitiba'));?></td>
...
<tbody class="tbodyBlue"><tr><td colspan="7"></td></tr></tbody>
    <tbody class="tbodyTopo">
        <?=lang('termo_acordo_show_curitiba') ?>
    </tbody>
    <br>
</table>
            ...
            <td style="width:50%;">
                <div style="width:100%;">
                    <center>
                        ...
                        <i><?=lang('inf_assinatura_termo_curitiba')?></i><br/>
