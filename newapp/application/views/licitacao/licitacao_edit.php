...
<div class="container-fluid">
        <h3>Pré Licitação</h3>
        <form id="form_licitacao" method="post" onsubmit="alterar_formato_dinheiro()">
            <div class="controls controls-row">
                <div class="span12">
                    <label>Orgão</label>
                    <input id="orgao" type="text" class="span12" name="orgao" value="<?=$orgao?>" required>
                </div>
            </div>
            <div class="controls controls-row">
                <div class="span2">
                    <label>Data da licitação</label>
                    <input id="data_licitacao" style="WIDTH: 175PX;" type="text" class="" value="<?=explode(' ',dh_for_humans($data_licitacao))[0];?>" name="data_licitacao" required>
                </div>
                <div class="span2">
                    <div class="form-group" >
                        <label for="periodo">Estado:</label>
                        <select style="WIDTH: 190PX;" class="form-control" name="estado" id="estado" required>
                ...
                <div class="span2">
                    ...
                    <select style="width: 190px;" class="form-control" name="esfera" id="esfera" required>
                        <option value="<?=$esfera?>"><?php if($esfera==0){echo "Federal";}elseif($esfera==1){echo "Estadual";}elseif($esfera==2){echo "Municipal";}?></option>  
                ...
                <div class="span2">
                    ...
                    <select style="width: 190px;" class="form-control" name="empresa" id="empresa" required>
                        <option value="<?=$empresa?>"><?php if($empresa==0){echo "Show";}elseif($empresa==1){echo "Norio";}?></option>    
                ...
                <div class="span2">
                    ...
                    <option value="<?=$tipo?>"><?php if($tipo==0){echo "Presencial";}elseif($tipo==1){echo "Eletrônico";}elseif($tipo==2){echo "Carona";}?></option> 
                ...
                <div class="span2" id='div_plataforma' style="display:none;">
                    ...
                    <input id="plataforma" style="WIDTH: 175PX;" type="text" class="" value="<?=$plataforma?>" name="plataforma">
                </div>
            </div>
            <div class="controls controls-row">
                <div class="span2">
                    <label>Tipo de contrato</label>
                    <select style="width: 190px;" class="form-control" name="tipo_contrato" id="tipo" required="">
                    <option value="<?=$tipo_contrato?>"><?php if($tipo_contrato==0){echo "Licitação";}elseif($tipo_contrato==1){echo "Adesão à ata";}?></option> 
                ...
                <div class="span2">
                    ...
                    <input id="qtd_veiculos" style="WIDTH: 175PX;" type="text" onchange="change_veic(this)" class="" value="<?=$qtd_veiculos?>" name="qtd_veiculos">
                </div>
                <div class="span2">
                    <label>Descrição do serviço</label>
                    <input id="descricao_servico" style="WIDTH: 175PX;" type="text" class="" value="<?=$descricao_servico?>" name="descricao_servico">
                </div>
                <div class="span2">
                    <label>Ata de registro de preço</label>
                    <select style="width: 190px;" class="form-control" name="ata_registro_preco" id="tipo" required="">
                        <option value="<?=$ata_registro_preco?>"><?php if($ata_registro_preco==0){echo "Não";}elseif($ata_registro_preco==1){echo "Sim";}?></option>    
                        <option value="0">Não</option>
                        <option value="1">Sim</option>
                    </select>
                </div><div class="span2">
                    <label>Situação preliminar</label>
                    <select style="width: 190px;" class="form-control" name="situacao_preliminar" id="situacao_preliminar">
                        <option value="<?=$situacao_preliminar?>"><?php if($situacao_preliminar==0){echo "Arrematado";}elseif($situacao_preliminar==1){echo "Perdido";}elseif($situacao_preliminar==2){echo "Não Participou";}elseif($situacao_preliminar==3){echo "Suspenso";}elseif($situacao_preliminar==4){echo "Anulado";}elseif($situacao_preliminar==5){echo "Em andamento";}?></option>   
            ...
            <div class="controls controls-row" style="border-bottom: solid 1px #bdbdbd;">
                <div class="span2">
                    <label>Meses</label>
                    <input id="meses" style="WIDTH: 175PX;" type="text" class="" onchange="change_veic(this)"  value="<?=$meses?>" name="meses">
                </div>
                <div class="span2">
                    <label>Valor unitário ref.</label>
                    <input id="valor_unitario_ref" style="WIDTH: 175PX;" type="text" data-prefix="R$ " class="" onchange="change_veic(this)" name="valor_unitario_ref">
                </div>
                <div class="span2">
                    <label>Valor instalação ref.</label>
                    <input id="valor_instalacao_ref" style="WIDTH: 175PX;" type="text" data-prefix="R$ " class="" onchange="change_veic(this)" name="valor_instalacao_ref">
                </div>
                <div class="span2">
                    <label>Valor global ref.</label>
                    <input id="valor_global_ref" style="WIDTH: 175PX;" type="text" data-prefix="R$ " class="" onchange="change_veic(this)" name="valor_global_ref">
                </div>
            </div>
            <div class="controls controls-row">
                ...
                <div class="span2">
                    ...
                    <input id="vencedor" style="WIDTH: 175PX;" type="text" class="" value="<?=$vencedor?>" name="vencedor">
                </div>
            </div>
            <div class="controls controls-row">
                <div class="span2">
                    <label>Valor unitário arremate</label>
                    <input id="valor_unitario_arremate" style="WIDTH: 175PX;" data-prefix="R$ " type="text" class="" onchange="change_veic(this)" name="valor_unitario_arremate">
                </div>
                <div class="span2">
                    <label>Valor instalação arremate</label>
                    <input id="preco_instalacao" style="WIDTH: 175PX;" data-prefix="R$ " type="text" class="" name="preco_instalacao" onchange="change_veic(this)">
                </div>
                <div class="span2">
                    <label>Valor global arremate</label>
                    <input id="valor_global_arremate" style="WIDTH: 175PX;" data-prefix="R$ " type="text" class="" onchange="change_veic(this)" name="valor_global_arremate">
                </div>
            </div>
            <div class="controls controls-row">
                <div class="span2">
                    <label>Situação final</label>
                    <select style="width: 190px;" class="form-control" name="situacao_final" id="situacao_final">
                    <option value="<?=$situacao_final?>"><?php if($situacao_final==0){echo "Aguardando";}elseif($situacao_final==1){echo "Contrato Assinado";}elseif($situacao_final==2){echo "Perdido";}elseif($situacao_final==3){echo "Suspenso";}elseif($situacao_final==4){echo "Em andamento";}elseif($situacao_final==4){echo "Em período de teste";}?></option>   
            ...
            <div class="controls controls-row">
                <div class="span12">
                    ...
                    <input id="observacoes" class="span12" type="text" class="" value="<?=$observacoes?>" name="observacoes" maxlength="150">
                </div>
            </div>
            <input type="hidden" id="status_licitacao" name="status" value="1">
            <button id="submit" onclick="$('#status_licitacao')[0].value='0'" class="btn btn-danger btn-large"><i id="load" style="font-size:18px;" class="fa fa-spinner fa-pulse fa-3x fa-fw display"></i>Excluir</button>
...
<script>
    ...
    $('#valor_unitario_ref').maskMoney('mask',<?=$valor_unitario_ref?>);
    $('#valor_global_ref').maskMoney('mask',<?=$valor_global_ref?>);
    $('#valor_global_arremate').maskMoney('mask',<?=$valor_global_arremate?>);
    $('#valor_unitario_arremate').maskMoney('mask',<?=$valor_unitario_arremate?>);
    $('#preco_instalacao').maskMoney('mask',<?=$preco_instalacao?>);
    $('#valor_instalacao_ref').maskMoney('mask',<?=$valor_instalacao_ref?>);
