...
<?php
    foreach ($clientes as $cliente):
        ...
        if ($uf == 'PB') {
    		...
    		$uf_cliente = 'PERNAMBUCO';

    	}elseif ($uf == 'RN') {
    		$uf_cliente = 'RIO GRANDE DO NORTE';
    		...
    		$uf_cliente = 'MATO GROSSO';
    		
    	}elseif ($uf == 'MS') {
    		$uf_cliente = 'MATO GROSSO DO SUL';
    		
    	}elseif ($uf == 'PA') {
    		$uf_cliente = 'PARÁ';
    		
    	}elseif ($uf == 'RJ') {
    		$uf_cliente = 'RIO DE JANEIRO';
    		
    	}elseif ($uf == 'RS') {
    		$uf_cliente = 'RIO GRANDE DO SUL';
    		...
    		$uf_cliente = 'TOCANTINS';
    		
    	}elseif ($uf == 'SP') {
    		$uf_cliente = 'SÃO PAULO';
    		
    	}elseif ($uf == 'PR') {
    		$uf_cliente = 'PARANÁ';
    		
    	}elseif ($uf == 'ES') {
    		$uf_cliente = 'ESPÍRITO SANTO';
    		
    	}elseif ($uf == 'MG') {
    		$uf_cliente = 'MINAS GERAIS';
    		
    	}elseif ($uf == 'SE') {
    		$uf_cliente = 'SERGIPE';
    		
    	}elseif ($uf == 'SC') {
            $uf_cliente = 'SANTA CATARINA';
...
(a) Monitoramento, rastreamento e localização do Veículo via web, nas hipóteses previstas na respectiva modalidade <strong>Contratada</strong>, somente em caso de roubo ou furto e demais de urgência; 
(b) Comunicação e colaboração com as autoridades competentes ou Prestadores de Serviços Autorizados sobre a localização do Veículo, excluídas todas e quaisquer situações não previstas expressamente neste instrumento.<br />
...
<strong>(b)</strong> Redu&ccedil;&atilde;o autom&aacute;tica de ajuste do alarme de velocidade em dias de chuva;<br>
<strong>(c)</strong> Leitura de coordenadas autom&aacute;tica via GPS, por transmiss&atilde;o local ou quaisquer outros meios que possibilitem a coleta de dados consistentes, fica a <strong>Contratante</strong> ciente do paragrafo &uacute;nico desta cl&aacute;usula;<br>
<strong>(d)</strong> Ainda no sistema informa&ccedil;&otilde;es dos registros das rotas percorridas pelos ve&iacute;culos;<br>
<strong>(e)</strong> Alarmes sonoros de: excesso de velocidade, rompimento de cerca eletrônica e desvio de rota com envio de informações via email e/ou software;<br>
<strong>(f)</strong> Registro de cada evento com a identificação do motorista, condicionando-o ao veículo por CNH ou com outros documentos vencidos;<br>
<strong>(g)</strong> Entre outras informações como Avaliação da jornada de trabalho; Identificação eletrônica do motorista/condutor; Estudo do perfil de cada condutor do veículo; Localização de veículos através de GPS (Global Positioning System)<br>
...
<span style="font-size: 1em"><b>Nº do Contrato: <?php echo $id_contrato ?></b></span>
    <br>
Av. Rui Barbosa, Nº 104 - CEP: 58200-000 - Centro - Guarabira/PB<br />www.showtecnologia.com | (83) 3271-6559</div>
