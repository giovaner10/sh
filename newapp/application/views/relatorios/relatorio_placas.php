<div class="text-title">
    <h3 style="padding: 0 20px; margin-left: 15px;"><?= lang("rel_placas_ativas_inativas") ?></h3>
    <h4 style="padding: 0 20px; margin-left: 15px;">
        <a style="text-decoration: none" href="<?= site_url('Homes') ?>">Home</a> >
        <?= lang('relatorios') ?> >
        <?= lang('rel_placas_ativas_inativas') ?>
    </h4>
</div>
...
<div class="row" style="margin: 15px 0 0 15px;">
                ...
                <div class="form-group filtro">
                    ...
                    <div class="input-container cliente">
                        ...
                        <select class="form-control" name="clienteBusca" id="clienteBusca" type="text" style="width: 100%;">
                            <option value="" disabled selected>Digite o nome do cliente</option>
                        </select>
                    </div>
    ...
    <div class="col-md-9" id="conteudo">
            <div class="card-conteudo card-placas" style='margin-bottom: 20px;'>
                <h3>
                    <b>Placas Ativas e Inativas: </b>
                ...
                <div class="registrosDiv">
                    <select id="select-quantidade-por-pagina-placas" class="form-control" style="float: left; width: auto; height: 34px;">
                ...
                <div style="position: relative;">
                    ...
                    <div class="wrapperPlacas">
                        <div id="tablePlacas" class="ag-theme-alpine my-grid-placas" style="height: 500px">
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<?= versionFile('assets/js/relatorios/placasAtivasInativas', 'RelatorioPlacas.js') ?>"></script>
