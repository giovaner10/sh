...
<div class="well well-small">
	...
	<form action="" method="get" class="form-horizontal pull-right">
		<?php if ($this->input->get()): ?>
			<a href="<?php echo site_url('servico/manutencao_troca_retirada')?>" class="btn btn-primary"><i class="icon-arrow-left icon-white"></i> Voltar</a>			
		<?php endif ?>
	...
	<table class="table table-hover">
		...
		<?php foreach ($contratos as $contrato): ?>
			...
			<tr>
				...
				<td align="center"><a href="<?php echo site_url('servico/gerar_ordem_servico/4/'.$contrato->id.'/'.$contrato->id_cliente.'/'.$contrato->quantidade_veiculos) ?>" target="_blank" title="Gerar OS - Manutenção"><i class="icon-wrench"></i></a></td>	
				<td align="center"><a href="<?php echo site_url('servico/gerar_ordem_servico/2/'.$contrato->id.'/'.$contrato->id_cliente.'/'.$contrato->quantidade_veiculos) ?>" target="_blank" title="Gerar OS - Troca"><i class="icon-refresh"></i></a></td>
				<td align="center"><a href="<?php echo site_url('servico/gerar_ordem_servico/3/'.$contrato->id.'/'.$contrato->id_cliente.'/'.$contrato->quantidade_veiculos) ?>" target="_blank" title="Gerar OS - Retirada"><i class="icon-share"></i></a></td>
			</tr>	
