...
<div class="text-title">
	<h3 style="padding: 0 20px; margin-left: 15px;"><?= lang('manutencao_troca_retirada') ?></h3>
	<h4 style="padding: 0 20px; margin-left: 15px;">
		<a style="text-decoration: none" href="<?= site_url('Homes') ?>">Home</a> >
		<?= lang('suporte') ?> >
		<a style="text-decoration: none" href="<?= site_url('servico') ?>"><?= lang('ordem_de_servicos') ?> </a> >
        <?= lang('manutencao_troca_retirada') ?>
	</h4>
</div>
...
<div class="row" style="margin: 15px 0 0 15px;">
	...
	<div class="col-md-9" id="conteudo">
		<div class="card-conteudo card-ordem" style='margin-bottom: 20px; position: relative;'>
			<h3>
				<b style="margin-bottom: 5px;"><?= lang('manutencao_troca_retirada') ?>: </b>
...
<script type="text/javascript" src="<?= versionFile('assets/js/suporte/Manutencao', 'index.js') ?>"></script>
<script type="text/javascript" src="<?= versionFile('assets/js/suporte/Manutencao', 'Exportacoes.js') ?>"></script>
