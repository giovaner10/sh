										...
										<tr>
											<td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px">
												<h1
													...
													APROVAÇÃO DE PEDIDO DE COMPRA</h1>
											</td>
										</tr>
										<tr>
											<td align="center" class="es-m-p0r es-m-p0l"
												...
												<table align="center" cellpadding="0" cellspacing="0" border="2" style="background-color:#ffffff; border:0; margin:0 auto; padding:10px; width:960px">
													<tbody>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Solicitante</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($nomeSolicitante) ? $nomeSolicitante : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Filial</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($filial) ? $filial : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Fornecedor</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($nomeFornecedor) ? $nomeFornecedor : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Forma de Pagamento</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($formaPagamento) ? $formaPagamento : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Condição de Pagamento</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($condicaoPagamento) ? $condicaoPagamento : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Valor Total</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($valorTotal) ? $valorTotal : '' ?></td>
														</tr>
														<tr>
															<th style="border: 1px solid #dddddd; text-align: left; padding: 8px;">Data de Emissão</th>
															<td style="border: 1px solid #ddd; text-align:left; padding: 8px;"><?= !empty($dataCadastro) ? $dataCadastro : '' ?></td>
														</tr>
													</tbody>
												</table>
											</td>
