										...
										<tr>
											<td align="center" class="es-m-p0r es-m-p0l"
												...
												<p
													...
													Caro colaborador, Informamos que foi cadastrada uma nova solicitação de compra no Portal de Compras.
													<br>
													<br>
													<br>
										...
										<tr>
											<td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
												<span
													...
													<a
														href="<?= site_url().'/PortalCompras/Solicitacoes' ?>" 
														class="es-button" 
														target="_blank"
											...
											<td align="center" class="es-m-p0r es-m-p0l"
												...
												<p
													style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
														...
														<?= site_url().'/PortalCompras/Solicitacoes' ?>
													</a>
												</p>
											</td>
										</tr>
