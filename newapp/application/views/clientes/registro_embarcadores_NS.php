			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab1">
					<div class="row dados">
						<div class="span8 col-sm-12">
							<fieldset class="cliente col-sm-12" id="0">
								<br>
								...
								<div class="fisica">
									<div class="form-group">
										<label class="control-label col-sm-2">Identidade:</label>
										<div class="col-sm-3">
								...
								<div class="form-group hide">
									<label class="control-label col-sm-2">GMT (+/- xx):</label>
									<div class="col-sm-6">
				...
				<div class="tab-pane" id="tab3">
					...
					<div class="row enderecos">
						<div class="col-sm-12 recipiente" style="margin-left: 25px">
							<div class="form-group">
								<label class="control-label col-sm-1">Endereço:</label>
								<div class="col-sm-6">
									<button type="button" class="btn btn-default adicionar" title="Adicionar" data-campos="endereco"><i class="fa fa-plus-circle" aria-hidden="true"></i> Adicionar</button>
								</div>
							</div> 
							<br>
							<fieldset class="col-sm-12 endereco" id="0">
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-3">
										<input type="text" name="endereco[0][latitude]" value="" class="form-control span6" placeholder="Latitude">
									</div>
									<div class="col-sm-3">
										<input type="text" name="endereco[0][longitude]" value="" class="form-control span6" placeholder="Longitude">
										<span class="help help-block"></span>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-6">
										<input type="text" id="cep" name="endereco[0][cep]" value="" class="form-control cep" placeholder="CEP">
										<span class="help help-block"></span>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-4">
										<input type="text" id="rua" name="endereco[0][rua]" value="" class="form-control upper" placeholder="Rua">
									</div>
									<div class="col-sm-2">
										<input type="text" id="numero" name="endereco[0][numero]" value="" class="form-control upper" placeholder="Número">
										<span class="help help-block"></span>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-6">
										<input type="text" id="bairro" name="endereco[0][bairro]" value="" class="form-control upper" placeholder="Bairro">
										<span class="help help-block"></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" id="cidade" name="endereco[0][cidade]" value="" class="form-control upper" placeholder="Cidade">
										<span class="help help-block"></span>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-6">
										<input type="text" name="endereco[0][complemento]" value="" class="form-control upper" placeholder="Complemento">
										<span class="help help-block"></span>
									</div>
								</div>
							</fieldset>
				...
				<div class="tab-pane" id="tab4">
					...
					<div class="row emails">
						<div class="col-sm-12 recipiente " style="margin-left: 5px">
							<div class="form-group">
								<label class="control-label col-sm-1">E-mail:</label>
								<div class="col-sm-6">
									<button type="button" class="btn btn-default adicionar" title="Adicionar" data-campos="email"><i class="fa fa-plus-circle" aria-hidden="true"></i> Adicionar</button>
								</div>
							</div> 
							<br>
							<fieldset class="email col-sm-12" id="0">
								<div class="form-group">
									<label class="col-sm-1"></label>
									<div class="col-sm-2">
									...
									<div class="col-sm-2">
										<input type="text" id="email" name="email[0][observacao]" value="" class="form-control upper" placeholder="Observação">
										<span class="help help-block"></span>
									</div>
								</div>
							</fieldset>
					...
					<div class="row telefones br">
						<div class="col-sm-12 recipiente"  style="margin-left: 5px">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<button type="button" class="btn btn-default adicionar" title="Adicionar" data-campos="telefone"><i class="fa fa-plus-circle" aria-hidden="true"></i> Adicionar</button>
								</div>
							</div> 
							<br>
		...
		$('.adicionar').on('click', function(e){
			...
			if($(this).data('campos') == 'endereco'){
				...
				var template = [
					...
					'<fieldset class="col-sm-12 endereco" id="',endereco_indice,'">',
						'<div class="form-group">',
							...
							'<div class="col-sm-3">',
								'<input type="text" name="name="endereco[',endereco_indice,'][latitude]" value="" class="form-control span6" placeholder="Latitude">',
							'</div>',
							'<div class="col-sm-3">',
								'<input type="text" name="name="endereco[',endereco_indice,'][longitude]" value="" class="form-control span6" placeholder="Longitude">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						...
						'<div class="form-group">',
							'<label class="col-sm-1"></label>',
							'<div class="col-sm-6">',
								'<input type="text" id="cep" name="endereco[',endereco_indice,'][cep]" value="" class="form-control cep" placeholder="CEP">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						...
						'<div class="form-group">',
							'<label class="col-sm-1"></label>',
							'<div class="col-sm-4">',
								'<input type="text" id="rua" name="endereco[',endereco_indice,'][rua]" value="" class="form-control upper" placeholder="Rua">',
							'</div>',
							'<div class="col-sm-2">',
								'<input type="text" id="numero" name="endereco[',endereco_indice,'][numero]" value="" class="form-control upper" placeholder="Número">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						...
						'<div class="form-group">',
							'<label class="col-sm-1"></label>',
							'<div class="col-sm-6">',
								'<input type="text" id="bairro" name="endereco[',endereco_indice,'][bairro]" value="" class="form-control upper" placeholder="Bairro">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						...
						'<div class="form-group">',
							'<label class="col-sm-1"></label>',
							'<div class="col-sm-2">',
								'<select name="endereco[',endereco_indice,'][uf]" id="estado" class="form-control">',
									'<option value="">UF</option>',
									'<option value="AC">AC</option>',
									'<option value="AL">AL</option>',
									'<option value="AP">AP</option>',
							...
							'</div>',
							'<div class="col-sm-4">',
								'<input type="text" id="cidade" name="endereco[',endereco_indice,'][cidade]" value="" class="form-control upper" placeholder="Cidade">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						...
						'<div class="form-group">',
							'<label class="col-sm-1"></label>',
							'<div class="col-sm-6">',
								'<input type="text" name="endereco[',endereco_indice,'][complemento]" value="" class="form-control upper" placeholder="Complemento">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
					'</fieldset>',
			...
			// adiciona email
				...
				var template = [
					'<fieldset class="email col-sm-12" id="',email_indice,'">',
						'<div class="form-group">',
							'<label class="control-label col-sm-1"><a href="#" title="Remover" class="remover"><i class="fa fa-minus-circle" aria-hidden="true"></i></a></label>',
							'<div class="col-sm-2">',
								'<input type="text" name="email[',email_indice,'][emails]" value="" class="form-control lower" placeholder="E-mail">',
							'</div>',
							'<div class="col-sm-2">',
							...
							'</div>',
							'<div class="col-sm-2">',
								'<input type="text" id="email" name="email[',email_indice,'][observacao]" value="" class="form-control upper" placeholder="Observação">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
					'</fieldset>',
				...
				var template = [
					'<fieldset class="telefone" id="',telefone_indice,'">',
						'<div class="control-group">',
							...
							'<label class="control-label col-sm-1"><a href="#" title="Remover" class="remover"><i class="fa fa-minus-circle" aria-hidden="true"></i></a></label>',
								'<div class="col-sm-1">',
									'<input type="text" id="ddd" name="telefone[',telefone_indice,'][ddd]" value="" class="form-control ddd" placeholder="DDD">',
								'</div>',
								'<div class="col-sm-1">',
									'<input type="text" id="tel" name="telefone[',telefone_indice,'][numero]" value="" class="form-control fone" placeholder="Número">',
								'</div>',
								'<div class="col-sm-2">',
								...
								'</div>',
								'<div class="col-sm-2">',
									'<input type="text" name="telefone[',telefone_indice,'][observacao]" value="" class="form-control upper" placeholder="Observação">',
									'<span class="help help-block"></span>',
								'</div>',
							'</div>',
						'</div>',
