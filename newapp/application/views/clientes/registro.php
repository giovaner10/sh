						...
						<div class="col-sm-12">
							<fieldset class="col-sm-12" id="0">
                                ...
                                <div id="vendedor" class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="cliente[id_vendedor]" class="form-control">
                                            <option></option>
                                            <?php foreach ($consultores as $consultor): ?>
                                                <option value="<?php echo $consultor->id ?>">
                                                    <?php echo $consultor->nome ?>
								...
								<div class="nota_fiscal">
									<div class="form-group">
										<label class="control-label col-sm-2">Nota Fiscal:</label>
										<div class="col-sm-6">
											<input type="text" name="cliente[cod_servico]" value="" class="form-control" placeholder="Código do serviço">
											<input type="text" name="cliente[descriminacao_servico]" value="" class="form-control" maxlength="100" placeholder="Descrição do serviço">
											<span class="help help-block"></span>
										</div>
									</div>
								</div>
								<div class="opentech">
									<div class="form-group">
										<label class="control-label col-sm-2">Opentech:</label>
										<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="control-label col-sm-2">Orgão:</label>
									<div class="col-sm-6">
			...
			if($(this).data('campos') == 'endereco'){
				...
				var template = [
					'<fieldset class="endereco" id="',endereco_indice,'">',
						...
						'<div class="form-group">',
							'<div class="col-sm-6">',
								'<input type="text" name="endereco[',endereco_indice,'][cep]" value="" class="form-control cep" placeholder="CEP">',
								'<span class="help help-block"></span>',
							'</div>',
						'</div>',
						'<div class="form-group">',
