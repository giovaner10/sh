...
<div class="text-title">
    <h3 style="padding: 0 20px; margin-left: 15px;"><?= lang("contatos") ?></h3>
...
<div class="row" style="margin: 15px 0 0 15px;">
    <div class="col-md-3">
        ...
        <?php
        menuLateralComponente(['Norio', 'Omnilink', 'Show Tecnologia', 'CEABS', 'Outros']);
        ?>
...
<script type="text/javascript" src="<?= versionFile('assets/js/empresa/contato', 'contato.js') ?>"></script>
