...
<div id="well" class="well well-small">
    ...
    <form action="" method="get" class="form-horizontal pull-right">
        ...
        <button id="btnSearch" type="submit" class="btn btn-small btn-info"><i class="icon-search icon-white"></i></button>
    </form>
        ...
        <?php if ($tickets): ?>
            ...
            <?php foreach ($tickets as $ticket): ?>
                ...
                <tr>
                    ...
                    <td><?php echo $ticket->status == 3 ? $ticket->data_fechamento : '<span>###</span>' ?></td>
