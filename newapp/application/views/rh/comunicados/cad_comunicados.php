...
<div class="well well-small">
	...
	<form class="form-horizontal" method="post" name="formcontato" enctype="multipart/form-data" action="<?php echo site_url('cadastros/cad_comunicado')?>">
    	<div class="box-body">
    		...
    		<div class="box-footer">
        		<div class="form-group">
        			...
        			<div class="col-sm-6">
        				...
        				<a href="listar_comunicados" class="btn btn-primary"> Voltar</a>
        			</div>
        		</div>
    		</div>
    	</div>
