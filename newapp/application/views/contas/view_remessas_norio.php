...
<h3 style="color: #7c7c7c;">Remessas - Norio</h3>
<hr>
<div class="row-fluid">

    <ul class="nav nav-tabs">
        <li><a href="#salario-tab" data-toggle="tab">Remessa de salário</a></li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active in" id="salario-tab">
            ...
            <button class="btn btn-success" onclick="gerar_remessa(1)">Gerar remessa</button>
            <div>
    ...
    <script>
        ...
        function get_intaladores_pendentes(){
            ...
            $.getJSON('<?=base_url()?>index.php/api/get_salarios_pendentes<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}else{echo "?empresa=3"; }?>',function (data){
                var instaladores=[];
                
                data.forEach(function write(d,index){
                    instaladores.push(['<input type="checkbox" name="id_contas_instaladores[]" value="'+d.conta_id+'"></input>','#'+d.conta_id,d.data_vencimento,'<span title="CPF/CPNJ: '+d.cpf+', Banco: '+d.banco+', Agência: '+d.agencia+', Conta: '+d.conta+'">'+d.fornecedor+'</span>','R$ '+d.valor]);
        ...
        function get_fornecedores_pendentes(){
            $('#instaladores_pendentes')[0].innerHTML="";
            document.getElementById("load").style.display=null;
            $.getJSON('<?=base_url()?>index.php/api/get_fornecedores_pendentes<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}else{echo "?empresa=3"; }?>',function (data){
                var fornecedores=[];
                data.forEach(function write(d,index){
                    if(d.banco=="001"){
        ...
        function get_remessas_titulo(){
            ...
            document.getElementById("load").style.display=null;
            $.getJSON('<?=base_url()?>index.php/api/get_titulo_pendentes<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}else{echo "?empresa=3"; }?>',function (data){
                var titulos=[];
                data.forEach(function write(d,index){
        ...
        function get_remessas_guia(){
            ...
            document.getElementById("load").style.display=null;
            $.getJSON('<?=base_url()?>index.php/api/get_guia_pendentes<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}else{echo "?empresa=3"; }?>',function (data){
                var guias=[];
                data.forEach(function write(d,index){
        ...
        function get_remessas_erros(){
            ...
            document.getElementById("load").style.display=null;
            $.getJSON('<?=base_url()?>index.php/api/get_remessa_erros<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}else{echo "?empresa=3"; }?>',function (data){
                var erros=[];
                data.forEach(function write(d,index){
                    if(d.banco=="001"){
        ...
        function gerar_remessa(guia){
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>index.php/api/get_remessa_salario<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}?>",
        ...
        function gerar_remessa_fornecedor(guia){
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>index.php/api/get_remessa_fornecedores<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}?>",
        ...
        function gerar_remessa_titulo(guia){
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>index.php/api/get_remessa_boleto<?php if($this->input->get("empresa")){echo "?empresa=".$this->input->get("empresa");}?>",
        ...
        function gerar_remessa_guia(guia){
            ...
            $.ajax({
                type: "POST",
                url: "<?=base_url()?>index.php/api/get_remessa_boleto?guia=1<?php if($this->input->get("empresa")){echo "&empresa=".$this->input->get("empresa");}?>",
