...
<?php endif; ?>
    ...
    <fieldset>
        ...
        <div class="row-fluid" style=' margin-left: 1px; width: 100%;       border-style: solid;
            ...
            <?php
            echo form_open_multipart(base_url() . "index.php/documentacoes/upload_file", "id = 'id-form'");
            ...
            <?php
            echo "<div class='span11' style='text-center'><br>";
            echo form_submit("upload", "Enviar", "class = 'btn btn-success  btn-block' id='id-upload' ");
            echo "</div>";
