<div class="text-title">
	<h3 style="padding: 0 20px; margin-left: 15px;"><?= lang('pcp_iscas_cliente') ?></h3>
	<h4 style="padding: 0 20px; margin-left: 15px;">
		<a style="text-decoration: none" href="<?= site_url('Homes') ?>">Home</a> >
		<?= lang('pcp') ?> > Iscas >
		<?= lang('pcp_iscas_cliente') ?>
	</h4>
</div>
...
<div class="row" style="margin: 15px 0 0 15px;">
	...
	<div class="card-conteudo card-iscas" style="margin-bottom: 20px;">
		<h3>
			<b style="margin-bottom: 5px;"><?= lang("pcp_iscas_cliente") ?>: </b>
		...
		<div style="position: relative;">
			...
			<div class="wrapperStatusIscaCliente">
				<div id="tableStatusIscaCliente" class="ag-theme-alpine my-grid-StatusIscaCliente" style="height: 500px">
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="<?= versionFile('assets/js/PCP', 'iscasCliente.js') ?>"></script>
