<div class="text-title">
	<h3 style="padding: 0 20px; margin-left: 15px;"><?= lang('pcp_lora') ?></h3>
...
<div class="row" style="margin: 15px 0 0 15px;">
			...
			<form id="formBusca">
				<div class="form-group filtro">
					...
					<div class="input-container buscaSerial">
						<label for="serialBusca">Serial LoRa:</label>
	...
	<div class="card-conteudo card-iscas" style="margin-bottom: 20px;">
		<h3>
			<b style="margin-bottom: 5px;"><?= lang("pcp_lora") ?>: </b>
			<div class="btn-div-responsive" id="btn-div-hot-list">
				...
				<div class="dropdown" style="margin-right: 10px; margin-bottom: 5px;">
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButtonLora" id="opcoes_exportacao" style="min-width: 100px; top: 62px; height: 91px;">
					</div>
				</div>
		...
		<div class="registrosDiv">
			<select id="select-quantidade-por-pagina-StatusLora" class="form-control" style="float: left; width: auto; height: 34px;">
		...
		<div style="position: relative;">
			...
			<div class="wrapperStatusLora">
				<div id="tableStatusLora" class="ag-theme-alpine my-grid-Lora" style="height: 500px">
				</div>
			</div>
		</div>
	</div>
...
<div id="importarLoraArquivo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<div class="col-md-12" style="padding-left: 0;">
					<div class="col-md-8 form-group" style="display: flex; padding-left: 8px;">
						<input class="form-control input-sm" style="margin-left: 5px" name="arquivoItens" id="arquivoItens" type="file">
				...
				<div class="wrapperImportacaoLora">
					<div id="tableImportacaoLora" class="ag-theme-alpine my-grid-lora">
					</div>
				</div>
			</div>
			<div class="modal-footer" style="margin-top: 30px;">
				<div class="footer-group" style="justify-content: flex-end;">
					<button type="button" class="btn btn-success" id='btnSalvarImportacaoLora'>Salvar</button>
				</div>
			</div>
		</div>
	</div>
...
<div id="importarLoraLote" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header header-layout">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			...
			<div class="modal-body">
				<h4 class="subtitle" style="margin-left: 4px;">Dados da Importação</h4>

				<div class="col-md-12" style="padding-left: 0;">
					<p style="margin-left: 10px;">Após digitar o serial é necessário pressionar a tecla "ENTER" para inseri-lo na tabela.</p>
					<div class="col-md-4 form-group" style="display: flex; padding-left: 8px;">
						<input class="form-control input-sm" style="margin-left: 4px" name="inputSerial" placeholder="Digite um Serial..." id="inputSerial" type="text">
					</div>
				...
				<div class="wrapperImportacaoLoraLote">
					<div id="tableImportacaoLoraLote" class="ag-theme-alpine my-grid-lora-lote">
					</div>
				</div>
			...
			<div class="modal-footer" style="margin-top: 50px;">
				<div class="footer-group" style="justify-content: flex-end;">
					<button type="button" class="btn btn-success" id='btnSalvarImportacaoLoraLote'>Salvar</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div id="comunicaco">
					<h4 class="subtitle">Última Comunicação</h4>
					<span id="ultimaComunicacao"></span>
					<hr>
				</div>

				<h4 class="subtitle">Dados do cliente</h4>
				<span id="dadosCliente"></span>
				<hr>
				<h4 class="subtitle">Dados de Localização</h4>
				<span id="dadosLocalizacao"></span>

				<div class="row" id="mapaLoraTela">
					<hr style="margin: 0;">
					<div class="col-lg-12 justify-items-center">
						...
						<div class="col-lg-12" style="position: relative; margin-bottom: 10px; padding: 0px;">
							...
							<div id="mapaDadosPartidaChegadaTela" style="width:100%; height:580px; border-radius: 9px; z-index: 1;"></div>
						</div>
					</div>
				</div>
			</div>
...
<div id="visualizarLora" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header-layout">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="titleIsca">Detalhes do Rastreador LoRa</h3>
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <div style="width: 100%; overflow-x: auto;">
                        <table class="table table-bordered table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td><span id='detalheSerial'></span></td>
                                    <td><span id='detalheStatus'></span></td>
                                    <td><span id='detalheEndereco'></span></td>
                                    <td><span id='detalheLatitude'></span></td>
                                    <td><span id='detalheLongitude'></span></td>
                                    <td><span id='detalheUltimaComunicacao'></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<link rel="stylesheet" type="text/css" href="<?= versionFile('assets/css/pcp', 'loraLayout.css') ?>">
<script type="text/javascript" src="<?= versionFile('assets/js/PCP', 'Exportacoes.js') ?>"></script>
<script type="text/javascript" src="<?= versionFile('assets/js/PCP', 'rastereadorLora.js') ?>"></script>
