<div class="text-title">
	<h3 style="padding: 0 20px; margin-left: 15px;"><?= lang('key_account') ?></h3>
...
<div class="row" style="margin: 15px 0 0 15px;">
    <div class="col-md-12" id="conteudo">
        <div id="card-key-account" class="card-conteudo card-ordem" style='margin-bottom: 20px; position: relative;'>
			<h3>
				<b style="margin-bottom: 5px;"><?= lang('key_account') ?>: </b>
				<div style="display: flex;flex-wrap: wrap; justify-content: space-between; align-items: center;">
                    <button class="btn btn-primary" id="btnAddAgendamento" onclick="formularioNovoKeyAccount()" type="button" style="margin-right: 10px; margin-bottom: 5px;"><i class="fa fa-plus" aria-hidden="true"></i> Cadastrar</button>
...
<script type="text/javascript" src="<?= versionFile('assets/js/ProcessosAtendimento/KeyAccount', 'index.js') ?>"></script>
<script type="text/javascript" src="<?= versionFile('assets/js/ProcessosAtendimento/KeyAccount', 'exportacoes.js') ?>"></script>

<script>
	var Router = '<?= site_url('ProcessosAtendimento/KeyAccount') ?>';
