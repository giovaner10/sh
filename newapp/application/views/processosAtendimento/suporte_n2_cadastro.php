<div id="modal_suporte" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label" for="suporte"><?= lang("titulo_suporte_n2") ?>:</label>
    ...
    $(document).ready(function() {
        ...
        $("#form_suporte").on("submit", function(evento) {
            ...
            if (formData.get("suporteId"))
                url = "<?= site_url('ProcessosAtendimento/SuporteN2/editarSuporte') ?>/" +
                formData.get("suporteId");
            else
                url = "<?= site_url('ProcessosAtendimento/SuporteN2/adicionarSuporte') ?>";
