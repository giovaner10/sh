...
if (!function_exists('boleto_bb')) {
    ...
    function boleto_bb($dados = null) {
        ...
        $dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato: 4020-2472";
        $dadosboleto["instrucoes4"] = "- E-mail: cobranca@showtecnologia.com";
        ...
        $dadosboleto["convenio"] = "2409314";  // Num do convenio - REGRA: 6 ou 7 ou 8 digitos
        ...
        $dadosboleto["variacao_carteira"] = "-019";  // Variaçãoo da Carteira, com traço (opcional)
