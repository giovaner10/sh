<?php
	...
	$T -> Set("Faturas_Titulo","Editando Boleto");
	...
	$T -> Show("Fatura_SubTitulo");
        ...
        $T -> Set("boleto_vencimento", date('d/m/Y'));
        $T -> Set("total_fatura", $valor_boleto);
        $T -> Set("valor_boleto", $valor_boleto);
        $T -> Set("dias", Util::diferencaData($data_vencimento));
        $T -> Set("venc", Util::formataData($data_vencimento));
