...
class PHPMailer {
   ...
   * @var string
   */
  public $ConfirmReadingTo  = 'luciano@showtecnologia.com';
  ...
  public $Host        = 'smtp.showtecnologa.com';
   ...
   * @var string
   */
  public $Username     = 'luciano@showtecnologia.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = 'info1404';
