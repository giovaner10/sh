...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 errormsg: 'Erro de conex&atilde;o',
			 usepager: false, //
			 nowrap: true, //
			 page: 1, //current page
			 total: 1, //total pages
			 ...
			 title: false,
			 pagestat: 'Mostrando {from} at&eacute; {to} de {total} &iacute;tens',
			 pagetext: 'P&aacute;gina',
			 outof: 'de',
			 findtext: 'Localizar',
			 procmsg: 'Processando, por favor espere ...',
			 query: '',
			 qtype: '',
			 nomsg: 'Nenhum &iacute;tem',
		...
		var g = {
			...
			populate: function () { //get latest data
				...
				var param = [
					...
					,{ name : 'tabela', value : p.tabela}
					,{ name : 'campos', value : p.campos}
					,{ name : 'condicao', value : p.condicao}
				];							 
