...
<body>
<center><img src="./{tpldir}/img/logo-showtecnologia.png" height="50" /></center>
<table align="center" >
<tr>
<td class="corpo">

<div align="center" class="titulo">CONTRATO DE LOCAÇÃO E PRESTAÇÃO DE SERVIÇOS <br>DE RASTREAMENTO E MONITORAMENTO VEICULAR</div>
<br><br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
neste ato representada na forma de seu Contrato Social, doravante denominada "<strong>Contratada</strong>"; e, de outro lado, {cliente},  
inscrita no CNPJ {cnpj}, {inscricao_estadual} endereço {endereco}, bairro {bairro}, cidade {cidade}, estado {estado}, 
...
<p><strong>1. DO OBJETO</strong> - O objeto do presente contrato consiste na locação de {qtd} módulos de rastreamento veicular;
