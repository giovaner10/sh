...
(function($) {
    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
                    ...
                    case "CPF":
                        errorMsg = methods._CPF(field, rules, i, options);
                        break;
        ...
        */
         ...
         * @return an error string if validation failed
         */
        _CPF: function(field, rules, i, options) {
            
        	var resposta = true, cpf = field.val().replace('.','').replace('.','').replace('-','');
            ...
            if (  (cpf.charAt(9) != a[9]) || (cpf.charAt(10) != a[10]) || cpf.match(expReg)  ) resposta = false;
            
            if (!resposta) return options.allrules.CPF.alertText;
